...
public final class NBTEditor {
	...
	public static void setNMSEntityTag( Object NMSEntity, Object value, Object... keys ) {
		if ( NMSEntity == null ) {
			return;
		}
		try {
	...
	public static boolean isCustomEntity(Entity entity) {
		...
		try {
			net.minecraft.world.entity.Entity NMSEntity = (net.minecraft.world.entity.Entity) getMethod( "getEntityHandle" ).invoke( entity );
			Set<String> tags = NMSEntity.af();
			return tags.contains("isCustomEntity");
		} catch ( Exception exception ) {
			exception.printStackTrace();
			return false;
		}
